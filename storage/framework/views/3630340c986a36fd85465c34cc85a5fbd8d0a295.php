            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-login">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="login_form" action="<?php echo e(route('login')); ?>" method="post" role="form" style="display: block;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <select name="city" id="city" class="form-control">
                                                    <option>--CITY--</option>
                                                    <?php foreach(\App\City::all() as $city): ?>
    ...
    <script>
        ...
        $("#mobile_reg").on('keyup', function (){
            if( $(this).val().length == 10 ) {
                ...
                var t = this;
                $.ajax({
                    url:'<?php echo e(route('checkmobile')); ?>',
                    type: "POST",
                    data: {"_token":"<?php echo e(csrf_token()); ?>", 'mobile': m}
                }).done(function (e) {
        ...
        function request_otp(m, callback){
            ...
            $.ajax({
                url: "<?php echo e(route('login.get_otp')); ?>",
                type: "POST",
                data: {"_token":"<?php echo e(csrf_token()); ?>", 'mobile': m}
            }).done(function (e) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partials.home_app', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>